...
class MstConditions(BaseModel):
    ...
    condition_operator = models.CharField(max_length=10, db_column='CONDITION_OPERATOR', null=True, blank=True)
    ...
    comparison_operator = models.CharField(max_length=10, db_column='COMPARISON_OPERATOR', null=True, blank=True)
